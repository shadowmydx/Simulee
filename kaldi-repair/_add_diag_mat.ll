...
define void @_Z17_add_diag_mat_matdPdiPKdiiiS1_iid(double %alpha, double* %v, i32 %v_dim, double* %M, i32 %M_cols, i32 %M_row_stride, i32 %M_col_stride, double* %N, i32 %N_row_stride, i32 %N_col_stride, double %beta) uwtable noinline {
  ...
  call void @llvm.dbg.declare(metadata !{double* %1}, metadata !20), !dbg !21
  store double* %v, double** %2, align 8
  call void @llvm.dbg.declare(metadata !{double** %2}, metadata !22), !dbg !21
  store i32 %v_dim, i32* %3, align 4
  call void @llvm.dbg.declare(metadata !{i32* %3}, metadata !23), !dbg !21
  store double* %M, double** %4, align 8
  call void @llvm.dbg.declare(metadata !{double** %4}, metadata !24), !dbg !21
  store i32 %M_cols, i32* %5, align 4
  call void @llvm.dbg.declare(metadata !{i32* %5}, metadata !25), !dbg !21
  store i32 %M_row_stride, i32* %6, align 4
  call void @llvm.dbg.declare(metadata !{i32* %6}, metadata !26), !dbg !21
  store i32 %M_col_stride, i32* %7, align 4
  call void @llvm.dbg.declare(metadata !{i32* %7}, metadata !27), !dbg !28
  store double* %N, double** %8, align 8
  call void @llvm.dbg.declare(metadata !{double** %8}, metadata !29), !dbg !28
  store i32 %N_row_stride, i32* %9, align 4
  call void @llvm.dbg.declare(metadata !{i32* %9}, metadata !30), !dbg !28
  store i32 %N_col_stride, i32* %10, align 4
  call void @llvm.dbg.declare(metadata !{i32* %10}, metadata !31), !dbg !28
  store double %beta, double* %11, align 8
  call void @llvm.dbg.declare(metadata !{double* %11}, metadata !32), !dbg !33
  call void @llvm.dbg.declare(metadata !{i32* %threads_per_element}, metadata !34), !dbg !36
  ...
  call void @llvm.dbg.declare(metadata !{i32* %v_idx}, metadata !39), !dbg !40
  ...
  call void @llvm.dbg.declare(metadata !{i32* %sub_idx}, metadata !42), !dbg !41
...
; <label>:27                                      ; preds = %0
  call void @llvm.dbg.declare(metadata !{double* %sum}, metadata !44), !dbg !45
  store double 0.000000e+00, double* %sum, align 8, !dbg !45
  call void @llvm.dbg.declare(metadata !{i32* %j}, metadata !46), !dbg !48
...
; <label>:29                                      ; preds = %61, %27
  ...
  br i1 %32, label %33, label %65, !dbg !48

; <label>:33                                      ; preds = %29
  call void @llvm.dbg.declare(metadata !{i32* %M_index}, metadata !49), !dbg !51
  ...
  call void @llvm.dbg.declare(metadata !{i32* %N_index}, metadata !53), !dbg !52
...
; <label>:65                                      ; preds = %29
  ...
  call void @__syncthreads(), !dbg !57
  call void @llvm.dbg.declare(metadata !{i32* %num_total_threads}, metadata !58), !dbg !59
...
; <label>:71                                      ; preds = %101, %65
  ...
  br i1 %73, label %74, label %103, !dbg !60

; <label>:74                                      ; preds = %71
  call void @llvm.dbg.declare(metadata !{i32* %half_point}, metadata !61), !dbg !63
  ...
  br i1 %80, label %81, label %101, !dbg !64

; <label>:81                                      ; preds = %74
  call void @llvm.dbg.declare(metadata !{double* %temp}, metadata !65), !dbg !67
  ...
  br i1 %86, label %87, label %94, !dbg !68
...
; <label>:103                                     ; preds = %71
  ...
  br i1 %105, label %106, label %125, !dbg !77
